...
Os mesmos gatilhos de **Quando Usar** acima — este cabeçalho é o que o ECC usa para a auto-ativação da skill.
...
### Exemplo: Melhoria de Manutenibilidade no Flask
...
### Exemplo: Bloco de Enforcement do AGENTS.md
...
### Exemplo: Anti-Patterns vs. Loop Correto
