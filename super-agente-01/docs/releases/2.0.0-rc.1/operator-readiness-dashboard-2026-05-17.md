...
Gerado: 2026-05-18T01:50:19.099Z
...
| Worktree local | Atual | 0 arquivos sujos bloqueadores; 1 entrada suja ignorada |
...
| --- | --- | --- | --- | --- |
| Manter PRs públicos abaixo de 20 | varredura ao vivo do GitHub em scripts/platform-audit.js | atual | 0 PRs abertos em 5 repositórios rastreados | repetir antes do release |
| Manter issues públicas abaixo de 20 | varredura ao vivo do GitHub em scripts/platform-audit.js | atual | 0 issues abertas em 5 repositórios rastreados | repetir antes do release |
...
- `ecc-tools-next-level`: completar readback de compra/webhook no Marketplace, então executar preflight e gate de anúncio ao vivo antes de publicar cópia de pagamentos nativos
...
3. Completar readback de compra/webhook no Marketplace das ECC Tools, então executar preflight e gate de anúncio ao vivo antes de publicar cópia de pagamentos nativos.
