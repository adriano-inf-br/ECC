...
description: Padrões do ORM JetBrains Exposed, incluindo consultas DSL, padrão DAO, transações, pool de conexões HikariCP, migrações Flyway e padrão repository.
metadata:
  origin: ECC
---
